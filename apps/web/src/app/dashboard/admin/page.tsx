            ...
            <CardContent className="p-4 sm:p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="text-2xl sm:text-3xl font-bold mt-0.5 sm:mt-1">
                ...
                <div
                  className={`p-2.5 sm:p-3 rounded-lg sm:rounded-xl ${kpi.bg} ${kpi.color}`}
                >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <Card className="lg:col-span-2">
          <CardHeader className="flex flex-row items-center justify-between pb-1 sm:pb-2 px-4 sm:px-6 pt-3 sm:pt-4">
            <div>
              ...
              <CardDescription>
                Monthly volume of intern submissions & reporting
              </CardDescription>
            </div>
          ...
          <CardContent className="px-3 sm:px-6 pb-4 sm:pb-6">
            <div className="h-[300px] w-full mt-2 sm:mt-4">
              <AreaTrendChart
                data={submissionsTrend.map((t: any) => ({
                  label: t.month,
        ...
        <Card className="lg:col-span-1">
          <CardHeader className="px-4 sm:px-6 pt-3 sm:pt-4 pb-2">
            ...
            <CardDescription>
              Conversion of candidates to active roles
            </CardDescription>
          </CardHeader>
          <CardContent className="flex flex-col items-center pb-6 sm:pb-8 pt-2 sm:pt-4 px-4 sm:px-6">
            ...
            <div className="mt-6 sm:mt-8 w-full grid grid-cols-2 gap-3 sm:gap-4">
              ...
              <div className="text-center p-2.5 sm:p-3 rounded-lg sm:rounded-xl bg-emerald-500/5 border border-emerald-500/20">
                ...
                <p className="text-lg sm:text-xl font-bold text-emerald-700 mt-0.5 sm:mt-1">
                  {counts.interns}
                </p>
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
          ...
          <CardContent className="px-3 sm:px-6 pb-4 sm:pb-6">
            <div className="min-h-[200px] w-full flex items-center justify-center py-4">
              <DonutChart
                ...
                centerLabels={{
                  label: "Universities",
                  value: counts.universities.toString(),
                }}
        ...
        <Card>
          <CardHeader className="px-4 sm:px-6 pt-3 sm:pt-4 pb-2">
            ...
            <CardDescription>
              Top academic fields in current batch
            </CardDescription>
          </CardHeader>
          <CardContent className="px-3 sm:px-6 pb-4 sm:pb-6">
            <div className="min-h-[200px] w-full flex items-center justify-center py-4">
              <DonutChart
                ...
                centerLabels={{
                  label: "Fields",
                  value: distributions.fields.length.toString(),
                }}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 pb-2">
        ...
        <Card>
          <CardHeader className="px-4 sm:px-6 pt-3 sm:pt-4 pb-2">
            ...
            <CardDescription>
              Allocation across organizational departments
            </CardDescription>
          </CardHeader>
          <CardContent className="px-3 sm:px-6 pb-4 sm:pb-6">
            <div className="min-h-[200px] w-full flex items-center justify-center py-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2 px-4 sm:px-6 pt-3 sm:pt-4">
            <div>
              ...
              <CardDescription>
                Current status of all application cycles
              </CardDescription>
            </div>
          ...
          <CardContent className="px-3 sm:px-6 pb-4 sm:pb-6">
            <div className="min-h-[200px] w-full flex items-center justify-center py-4">
              <DonutChart
                ...
                centerLabels={{
                  label: "Batches",
                  value: counts.applications.toString(),
                }}
