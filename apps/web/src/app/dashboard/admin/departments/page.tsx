...
export default function DepartmentsPage() {
  ...
  const [newDept, setNewDept] = useState<{
    ...
    description: string;
  }>({ name: "", type: "SOFTWARE_DEVELOPMENT", description: "" });
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Manage institutional departments and scientific domains
          </p>
        </div>
        <Button
      ...
      {showForm && (
        <Card className="border-primary/20 bg-primary/1">
          <CardHeader className="pb-4">
            <CardTitle className="text-base">
              Registration: New Department
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid gap-4 grid-cols-1 md:grid-cols-2">
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  value={newDept.type}
                  onChange={(e) =>
                    setNewDept({ ...newDept, type: e.target.value as any })
                  }
                >
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                placeholder="Describe the department's primary focus..."
              />
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {loading ? (
          ...
          departments.map((dept) => (
            <Card
              key={dept.id}
              className="group hover:shadow-md transition-all duration-300 border-none bg-muted/40"
            >
              <CardHeader className="pb-4">
                ...
                <CardDescription className="line-clamp-2 text-xs min-h-8">
      ...
      <Dialog open={showEditDialog} onOpenChange={setShowEditDialog}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Modify metadata for {editingDept?.name}
            </DialogDescription>
          </DialogHeader>
