    ...
    >
      ...
      <div className="mt-auto px-3 py-4 space-y-1 border-t border-border/40">
        ...
        <button
          type="button"
          onClick={() => logout()}
          className="group/logout flex items-center h-[40px] w-full rounded-xl transition-all duration-200 text-muted-foreground/80 hover:bg-destructive/10 hover:text-destructive"
        >
          <div className="flex w-[52px] h-full items-center justify-center shrink-0">
            <LogOut
